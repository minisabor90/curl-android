...
LOCAL_C_INCLUDES        :=  $(LOCAL_PATH)/curl/lib/curlx $(LOCAL_PATH)/curl/src $(LOCAL_PATH)/curl/include $(LOCAL_PATH)/curl/lib $(LOCAL_PATH)/brotli/c/include 
...
LOCAL_C_INCLUDES        :=  $(LOCAL_PATH)/curl/lib/curlx $(LOCAL_PATH)/curl/src $(LOCAL_PATH)/curl/include $(LOCAL_PATH)/curl/lib $(LOCAL_PATH)/brotli/c/include $(LOCAL_PATH)/uv/
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
    LOCAL_C_INCLUDES    += $(LOCAL_PATH)/config32
else ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
    LOCAL_C_INCLUDES    += $(LOCAL_PATH)/config64
